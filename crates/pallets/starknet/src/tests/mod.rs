...
pub fn get_invoke_dummy(nonce: Felt252Wrapper) -> InvokeTransactionV1 {
    ...
    InvokeTransactionV1 { max_fee: u64::MAX as u128, signature, nonce, sender_address, calldata }
}
...
fn get_invoke_argent_dummy() -> InvokeTransactionV1 {
    ...
    InvokeTransactionV1 { max_fee: u64::MAX as u128, signature: vec![], nonce, sender_address, calldata }
}
...
pub fn set_infinite_tokens<T: Config>(contract_address: &ContractAddress) {
    ...
    println!("{:#?} {:#?} {:#?}", contract_address, low_key, high_key);
