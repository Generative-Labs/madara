...
/// StateWriter is responsible for applying StarkNet state differences to the underlying blockchain state.
    ...
    BE: Backend<B>,
{
	...
	///
	/// This method takes the inner StarkNet state difference, StarkNet block number, and StarkNet block hash,
	/// and applies the changes to the Substrate blockchain state. It calculates the state root after the storage
	/// change and commits the operation to the Substrate backend.
	///
	/// # Arguments
	///
	/// * `starknet_block_number` - StarkNet block number associated with the inner state difference.
	...
	///
	/// This method takes the information of the best StarkNet block in the blockchain, the desired block number,
	/// and creates a new StarkNet block with the appropriate header.
	///
	/// # Arguments
	///
