...
mod tests {
    ...
    use crate::{l1::L1SyncContext, ethereum::{EthereumStateUpdate, EthereumApi, EthereumChain}};

    use super::*;
    use l1::sync_from_l1_loop;
    ...
    async fn test_sync_from_l1_loop() {
        ...
        // For example, you can use the tokio::time::sleep to wait for a specific duration and then check the state.
